...
export function ConferenceSite() {
  ...
  useEffect(() => {
    ...
    link.rel = "stylesheet";
    link.href = "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,500;0,600;0,700;1,300;1,400;1,600&family=DM+Sans:wght@300;400;500&family=Libre+Baskerville:ital@1&display=swap";
  ...
  return (
    ...
    >
      ...
      <section className="relative h-screen min-h-[700px] flex flex-col items-center justify-center overflow-hidden">
        ...
        >
          <img
            src="/__mockup/assets/ogImage.png"
            alt=""
        ...
        <nav className="absolute top-0 left-0 right-0 z-30 flex justify-between items-center px-10 py-6">
          <div className="flex items-center gap-3">
            <img src="/__mockup/assets/logo.png" alt="JoyceWays" className="h-9 opacity-90" />
          </div>
          <div
              ...
              <div className="relative overflow-hidden border border-[#236480]/25 bg-[#0a0d0f] h-full group hover:border-[#236480]/60 transition-all duration-500">
                ...
                <div className="p-10">
                  ...
                  <div className="flex items-start gap-5 mb-6">
                    <img src="/__mockup/assets/logo.png" alt="JoyceWays" className="h-14 w-14 object-contain opacity-80 shrink-0" />
                    <div>
                      <h3
                      ...
                      <p className="text-white/40 text-sm mt-1 italic" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
                        Ulysses For You
                      </p>
                    </div>
                  </div>
      ...
      <footer className="border-t border-white/8 py-16 px-6">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
          <div className="flex items-center gap-4">
            <img src="/__mockup/assets/logo.png" alt="JoyceWays" className="h-8 opacity-60" />
            <div>
